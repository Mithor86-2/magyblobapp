...
| E     | [Configuración (zona de padres)](epic-e-config.md)  | US-11, US-12, US-13, US-66, US-68                                                                                                                                                                                                                   |
...
| US-68 | Config del app por JSON + sync versionado | Should    | Mejoras | — (backend/BD)                      | [E](epic-e-config.md#us-68)      |
