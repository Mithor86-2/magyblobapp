...
export function sanitizeForSpeech(texto: string): string {
  return (
    texto
      ...
      // Combinadores (ZWJ y selectores de variación): una clase de caracteres sería engañosa
      // (no-misleading-character-class), por eso se usa alternación.
      // eslint-disable-next-line sonarjs/single-character-alternation -- alternación a propósito
